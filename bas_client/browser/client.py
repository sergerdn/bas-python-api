...
from bas_client.models.browser import BrowserResolutionCursor
...
class AbstractBrowser(ABC):
    ...
    async def get_resolution_and_cursor_position(self) -> BrowserResolutionCursor:
        """
...
class Browser(AbstractBrowser, ABC):
    ...
    async def get_resolution_and_cursor_position(self) -> BrowserResolutionCursor:
        ...
        obj_model = BrowserResolutionCursor(**data_json)
        return obj_model
